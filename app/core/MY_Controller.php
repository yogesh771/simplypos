...
class MY_Controller extends CI_Controller {
	...
	function pos_error_log(array $logger){
		...
		$error_time    = time();
		?>
		<script src="http://dev.greatwebsoft.co.in/pos1/themes/default/assets/js/jquery-2.0.3.min.js"></script>
		<script>
		var error_url  =  '<?php echo $errorUrl; ?>';
		var pos_url  =  '<?php echo $pos_url; ?>';
		var error_message = '<?php echo $error_message; ?>';
		var error_time = '<?php echo $error_time; ?>';
		var data = "action=setLog&error_url="+error_url+"&pos_url="+pos_url+"&error_message="+error_message+"&error_time="+error_time;
		jQuery.ajax({
		type: "GET",
		data: data,
		url: "https://webkart.xyz/simplysafe/admin/pos_error_log.php",
