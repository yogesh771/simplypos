...
<div id="app_wrapper">
    <header id="header" class="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= site_url() ?>"><span class="logo"><?= $Settings->site_name ?></span>&nbsp;<sub><?= $Settings->pos_version ?></sub></a>
                ...
                <ul class="nav navbar-nav pull-right">
                    <li class="dropdown">
                        <a class="btn account dropdown-toggle" data-toggle="dropdown" href="#">
                            <img alt="" src="<?= $this->session->userdata('avatar') ? site_url() . 'assets/uploads/avatars/thumbs/' . $this->session->userdata('avatar') : base_url('assets/images/male.png'); ?>" class="mini_avatar img-rounded">
                ...
                <div class="sidebar-nav nav-collapse collapse navbar-collapse" id="sidebar_menu">
                    <ul class="nav main-menu">
                        ...
                        if ($Owner || $Admin) {
                            ...
                            <li class="">
                                <a class="submenu" href="<?= site_url('cust'); ?>">
                                    <i class="fa fa-info-circle"></i><span class="text"> <?= lang('Customer Email'); ?></span>
                                </a>
                            </li>
                            <?php if ($Owner) { ?>
